...
export function OfferSummary({
  ...
  return (
    <Card
      padding="lg"
      className="space-y-6 border-[var(--core-color-border-default)] bg-[var(--core-color-surface-canvas)]"
    >
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <span className="text-xs uppercase tracking-wide text-[var(--core-color-text-muted)]">
              Total contract value
            </span>
            <span className="text-2xl font-semibold text-[var(--core-color-text-primary)]">
